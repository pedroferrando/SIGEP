...
class orden_compra extends FPDF {
    ...
    function Header() {
        ...
        $this->Image('logo_sumar.jpg', 115, 10, 85);
        $this->line(110, 5, 110, 32);
        $this->line(5, 32, 205, 32);
        $this->SetFont('Arial', 'B', 12);
        $this->setxy(25, 5);
        $this->Cell(80, 10, "Liquidación de Prestaciones");
        $this->SetFont('Arial', 'B', 12);
        $this->setxy(15, 18);
        $this->cell(85, 5, "Periodo Actual");
        $this->setxy(60, 18);
        ...
        $this->cell(200, 9, 'Número: ', 1, 1, 'L', 1);
        if ($this->PageNo() != 1) {
            $this->setxy(5, 45);
            $this->SetFontSize(11);
...
////////////////////////////////////////////
    function fecha($fecha) {
        ...
        $this->SetFont('Arial', 'B', 12);
        $this->setxy(155, 33);
        $this->cell(32, 6, 'Fecha:');
        $this->setxy(170, 33);
        $this->cell(26, 6, $fecha, 0, 0, R);
    }
    ...
    function proveedor($nombre) {
        ...
        $this->SetFont('Arial', '', 12);
        $this->setxy(46, $this->recuperar_base1() + 2);
        $this->cell(110, 6, "- " . $nombre, 0, 0, L);
    }

    function vendedor($nombre) {

        $this->SetFont('Arial', '', 12);
        $this->setxy(27, $this->recuperar_base1() + 2);
        $this->cell(40, 6, $nombre, 0, 0, L);
    }

    function tipodeliquidacion($tipoliquidacion) {
        $this->setxy(65, 32);
        $this->SetFont('Arial', 'B', 12);
        if ($tipoliquidacion == 'R') {
            $this->cell(60, 6, "(Refacturación)", 0, 0, L);
        } else {
            $this->cell(60, 6, "(Vigente)", 0, 0, L);
        }
    }
    ...
    function contrato($contrato) {
        ...
        $this->SetFont('Arial', 'B', 12);
        $this->setxy(7, $this->recuperar_base1() + 14);
        $this->cell(40, 6, "Contrato: ", 0, 0, L);
        $this->SetFont('Arial', '', 12);
        $this->setxy(28, $this->recuperar_base1() + 14);
        $this->cell(40, 6, $contrato, 0, 0, L);
    }

    function cuenta($nombre, $cuenta) {

        $this->SetFont('Arial', 'B', 12);
        $this->setxy(120, $this->recuperar_base1() + 8);
        $this->cell(40, 6, "Banco: ", 0, 0, L);
        $this->SetFont('Arial', '', 12);
        $this->setxy(144, $this->recuperar_base1() + 8);
        $this->cell(40, 6, $nombre, 0, 0, L);
        $this->setxy(120, $this->recuperar_base1() + 14);
        $this->SetFont('Arial', 'B', 12);
        $this->cell(40, 6, "Cuenta Nº: ", 0, 0, L);
        $this->setxy(144, $this->recuperar_base1() + 14);
        $this->SetFont('Arial', '', 12);
        $this->cell(40, 6, $cuenta, 0, 0, L);
    }
    ...
    function producto($nom_ape, $cantidad, $unitario, $moneda) {
        ...
        $this->MultiCell(135, 6, $nom_ape, 'TRLB', 'L');
        $y_posterior = $this->GetY();

        $this->setxy(140, $this->recuperar_base2());
        $this->cell(20, 6, $cantidad, 'TRBL', 0, 'C');
        $this->setxy(160, $this->recuperar_base2());
...
//	$this->cell(30,6,'Nº Orden de Compra ');
        ...
        $this->setxy(7, $this->recuperar_base1() + 2);
        $this->cell(30, 6, 'Efector: ', 0);
//           $this->setxy(5, $this->recuperar_base1() + 2);
//        $this->cell(30, 6, 'CUIE ',0);
//        $this->setxy(7, $this->recuperar_base1() + 22);
//        $this->SetFont('Arial', '', 9);
//        $this->cell(200, 5, 'Por la presente cumplo  dirigirme a  Usted solicitando  la  provisión de las prestaciones que  detallo a continuación.');
//        $this->setxy(7, $this->recuperar_base1() + 27);
//        $this->cell(200, 5, 'Solicito me responda por este mismo medio la conformidad de la misma.');
//        $this->setxy(5, $this->recuperar_base1() + 35);
//        $this->cell(35, 6, 'Observaciones: ');
//        $this->Rect(5, $this->recuperar_base1() + 35, 200, 20);
        //$this->setxy(7, $this->recuperar_base1() + 28);
        $this->SetFont('Arial', 'B', 11);
        $this->setxy(5, $this->recuperar_base1() + 22);
        $this->cell(135, 6, 'DATOS', 'RLTB', 0, 'C');
        $this->setxy(140, $this->recuperar_base1() + 22);
        $this->cell(20, 6, 'Cantidad', 'RLTB', 0, 'C');
        $this->setxy(160, $this->recuperar_base1() + 22);
        $this->cell(20, 6, 'Unitario', 'RLTB', 0, 'C');
        $this->setxy(180, $this->recuperar_base1() + 22);
...
//fin de funcion
    ...
    function Footer() {
        ...
        $this->Cell(0, 10, 'Liquidación de Prestaciones - Página ' . $this->PageNo() . '/total_pag' . ' - Impreso: ' . $fecha_carga , 0, 0, 'C');
    }
