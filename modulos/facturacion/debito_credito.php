...
$sql = "select nd.id_nomenclador_detalle,nd.descripcion from nacer.efe_conv ec
		left join nacer.conv_nom cn using (id_efe_conv)
		left join facturacion.nomenclador_detalle nd on cn.id_nomenclador_detalle=nd.id_nomenclador_detalle
	 where ec.cuie='$cuie'
              ...
              <table>
                <tr>
                  <td align="center" colspan="2">
                    <b> Numero de Factura: <font size="+1" color="Red"><?= $func_nroFactura ? $res_comprobante->fields['numero_factura'] : $id_factura ?></font> </b>
                  </td>
                </tr>
                <tr>
                  <td align="center" colspan="2">
                ...
                <tr>
                  ...
                  <td align='left'>
                    <b><input type='text' name='nombre' value='<?= $nombreefector; ?>' size=60 align='right' readonly></b>
                  </td>
                </tr>
                    ...
                    <select name=id_nomenclador Style="width:700px"
                      ...
                      if ($res_flag->recordCount() > 0) {
                        $sql = "select *
									...
									where cuie='$cuie' and id_nomenclador_detalle=$id_nomenclador_detalle
			                 		ORDER BY codigo";
                      } else {
