...
excel_header("debito_credito.xls");
?>
...
<form name=form1 method=post action="debito_excel.php">
  ...
  <table width="100%" align=center cellspacing="0" cellpadding="5" class="bordes"> 
    ...
    <tr id="sub_tabla">
      <td>
        <font face="arial" size="3"><b>INFORME DE PRESTACIONES<?php if($estado == 'A') echo '<span style="color:red;">(FACTURA ABIERTA)</span>' ?></b></font>
      </td>
    </tr>
    <tr bgcolor="#f6bebe">
      <td>
    ...
    <tr bgcolor="#f6bebe">
      <td>
        <font face="arial" size="2"><b>ATTE: DR MARIO DANIEL MERCADO</b></font>
      </td>
    </tr>  
    ...
    <tr>
      <td>
        <font face="arial" size="2">Numero de Factura: <b><?= $func_nroFactura ? $result1->fields['numero_factura'] : $result1->fields['id_factura'] ?></b></font>
      </td>
    </tr>
  ...
  <table width="100%" align=center border=1 bordercolor=#585858 cellspacing="0" cellpadding="5"> 
    ...
    <? while (!$result->EOF) { ?>  
      <tr>     
        ...
        <td><?= number_format($result->fields['cantidad'] * $result->fields['monto'], 2, ',', '.') ?></td>    
        <td>
          <?php echo $result->fields['id_motivo_d'] != 0 ? $result->fields['descripcion'] : $result->fields['mensaje_baja'] ?>
        </td>
