...
echo "<td align=center><a id=ma href='".encode_link("tareas_designadas.php",Array('sort'=>3,'up'=>$up2,'page'=>$page,'keyword'=>$keyword,'filter'=>$filter))."'>Descripción</a></td>";
...
echo "<td align=center><a id=ma href='".encode_link("tareas_designadas.php",Array('sort'=>7,'up'=>$up2,'page'=>$page,'keyword'=>$keyword,'filter'=>$filter))."'>Solución</a></td>";
