...
$graph->subtitle->Set("Prestaciones del Efector en el Periodo y Diagnostico Seleccionados Agrupados por Diagnostico (Discrimina Beneficiarios y NO Beneficiarios)");
...
$b1->SetLegend("Beneficiarios Activos");

// Create a red line plot
$p1 = new BarPlot($periodos_array_ant);
$p1->SetLegend("Poblacion NO Beneficiaria");
