...
<br>
	...
	<?
	$sql1= "SELECT id_nomenclador_detalle FROM nacer.efe_conv
		   where (cuie='$cuie')";
	$res_1=sql($sql1) or fin_pagina();
	$id_nomenclador_detalle=$res_1->fields['id_nomenclador_detalle'];
	
	if($id_nomenclador_detalle=="")$id_nomenclador_detalle=0;
	?>
					 	<tr>
