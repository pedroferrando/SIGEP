...
<tr align="center">	
	<td align="center">
		<input type="button" name="Carga Valores" value="Carga Valores" onclick="var entrar=confirm('CUIDADO!! Usted esta por ingresar a un área de configuración de sistema de indicadores esto solo debe hacerse con autorización del directorio y el gerente de calidad.'); if ( entrar ) window.open ('indicadores_guardar_ins.php');">
	</td>
</tr>
</table>
<?}?>
