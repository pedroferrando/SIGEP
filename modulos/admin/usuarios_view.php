...
function detalle_usuario($id_usuario) {
	...
	$sql .= "FROM usuarios LEFT JOIN phpss_account ";
	$sql .= "ON usuarios.login = phpss_account.username ";
        $sql .= "LEFT JOIN uad.uad_x_usuario on uad_x_usuario.id_usuario=usuarios.id_usuario ";
	...
	<table align=center cellpadding=5 cellspacing=0 bgcolor=$bgcolor2>
		...
		<td align=left>".$fila['mail']."</td>
                ...
                <tr><td align=right><b>UAD:</b></td>
		<td align=left>".$fila['cod_uad']."</td>
		</tr>
	    <tr>
	    <td align='center' colspan='2'>
	      <hr>
...
function listado_usuarios() {
	global $bgcolor3,$up,$itemspp,$sino,$id_usuario_conect;
	$orden = array(
		"default" => "1",
		"1" => "usuarios.login",
		"2" => "usuarios.nombre",
