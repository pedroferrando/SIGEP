...
variables_form_busqueda("resumen_planillas_tra");
...
$where_tmp=" tipo='Trazadoras' 
  GROUP BY
smiefectores.nombreefector";
echo $html_header;
?>
<form name=form1 action="resumen_planillas_tra" method=POST>
     ...
     <tr>
      ...
      (Ej: 2007/12 2008/02)
	    ...
	    &nbsp;&nbsp;<input type=submit name="buscar" value='Buscar'>		    
	     &nbsp;&nbsp;
	    <? $link=encode_link("resumen_planillas_tra_excel.php",array("sql"=>$sql));?>
