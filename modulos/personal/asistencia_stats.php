			...
			<table border="1" width="95%" cellpadding="1" bgcolor="White" align="center">
				<tr>
					<?
						...
						$asist = "select DISTINCT fecha from asistencia where (".(($id_legajo)?"id_legajo=".$id_legajo:"false").(($id_usuario)?" or id_usuario=".$id_usuario:" or false ").") and fecha ilike '%".$agno_resumen."-";
				...
				<tr>
					<?
						...
						for ($i=1; $i<count($asistencia); $i++){
							...
							echo "<td align='center' bgcolor='$colorDia' style='cursor:pointer;' onclick=\"document.location.href='".encode_link("asistencia_stats.php",array("dia_seleccionado"=>$i, "id_usuario"=>$id_usuario, "id_legajo"=>$id_legajo, "mes_resumen"=>$mes_resumen, "agno_resumen"=>$agno_resumen))."'\"><font color=".contraste($colorDia, '#0000FF', '#FFFFFF')."><b>$i</b><font></td>";
						}
					?>
				</tr>
			</table>
