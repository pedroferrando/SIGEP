...
function form_modificar($nuevo = false,$id = "") {
	...
	echo "<tr><td style=\"border:$bgcolor3;\" colspan=2 align=center id=mo><font size=+1>Evaluación de competencia individual</font></td></tr>";
	...
	echo "</tr><tr>";
	echo "<td align=left><b>Período: </b>$periodo</td>";
	echo "</tr><tr>";
	echo "<td style=\"border:$bgcolor3;\" colspan=2 align=center id=mo><font size=+1>Calificación global de desempeño</font></td>";
	echo "</tr><tr>";
	echo "<td colspan=2>";
	echo "<table border=0 width=100% cellpadding=3><tr>";
	echo "<td align=left width=50%><b>0</b> No satisface requerimientos</td>";
	echo "<td align=left width=50%><font size='-2'>Desempeño con deficiencias</font></td>";
	echo "</tr><tr>";
	echo "<td align=left><b>50</b> Satisface requerimientos mínimos</td>";
	echo "<td align=left><font size='-2'>Desempeño que no siempre satisface los requerimientos del puesto o lo hace en forma marginal</font></td>";
	echo "</tr><tr>";
	echo "<td align=left><b>75</b> Satisface requerimientos</td>";
	echo "<td align=left><font size='-2'>Desempeño que cumple con los normales del puesto</font></td>";
	echo "</tr><tr>";
	echo "<td align=left><b>100</b> Cumple y supera requerimientos</td>";
	echo "<td align=left><font size='-2'>Desempeño claramente superior a los normales</font></td>";
	echo "<tr></table></td>";
	echo "</tr><tr>";
	echo "<td style=\"border:$bgcolor3;\" colspan=2 align=center id=mo><font size=+1>Evaluación de competencia</font></td>";
	echo "</tr><tr>";
	echo "<td colspan=2>";
	...
	if ($result->RecordCount() == 0) {
		...
		echo "<td align=center width=60%><b>DEFINICIÓN</b></td>";
		...
		echo "<tr><td colspan=2 align=center><b>CALIFICACIÓN GLOBAL</b></td>";
    ...
    if ($_ses_user["login"]=="ferni" ||  $_ses_user["id"]==$id_legajo_evaluador)
          {
          $disabled_pf="";
    ...
    echo "</textarea></td>";
	echo "</tr><tr>";
	echo "<td colspan=2>Puntos Débiles o a Mejorar del Evaluado:<br>";
