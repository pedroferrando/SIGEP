...
function form_modificar($nuevo = false,$id = "") {
  ...
  $id_afjp=$_POST['leg_afjp'];
	...
	echo "<tr><td style=\"border:$bgcolor3;cursor:pointer;\" colspan=2 align=center id=mo onclick=\"muestra_tabla(document.all.tabla_datos_personales,0);\">
		<img id=\"imagen_0\" src=\"../../imagenes/dropdown2.gif\" border=0 title=\"Mostrar columnas\" align=\"left\" style=\"cursor:pointer;\">
	...
	?>
	<tr>
		<td style=\"border:$bgcolor3;cursor:pointer;\" colspan=2 align=center id=mo onclick="muestra_tabla(document.all.tabla_datos_laborales,1);">
			<img id="imagen_1" src="../../imagenes/drop2.gif" border=0 title="Mostrar columnas" align="left" style="cursor:pointer;">
...
<script>document.all.promociones_ids.value=<?=$i?></script>
	...
	<tr>
		<td style=\"border:$bgcolor3;cursor:pointer;\" colspan=2 align=center id=mo onclick="muestra_tabla(document.all.tabla_familia,2);">
			<img id="imagen_2" src="../../imagenes/drop2.gif" border=0 title="Mostrar columnas" align="left" style="cursor:pointer;">
...
<script>document.all.familiares_ids.value=<?=$i?></script>
	...
	<tr>
		<td style=\"border:$bgcolor3;cursor:pointer;\" colspan=2 align=center id=mo onclick="muestra_tabla(document.all.tabla_conocimientos,3);">
			<img id="imagen_3" src="../../imagenes/drop2.gif" border=0 title="Mostrar columnas" align="left" style="cursor:pointer;">
...
<script>document.all.idiomas_ids.value=<?=$i?></script>
	...
	<tr>
		<td style=\"border:$bgcolor3;cursor:pointer;\" colspan=2 align=center id=mo onclick="muestra_tabla(document.all.tabla_referencias,4);">
			<img id="imagen_4" src="../../imagenes/drop2.gif" border=0 title="Mostrar columnas" align="left" style="cursor:pointer;">
...
<script>document.all.referencias_ids.value=<?=$i?></script>
	...
	<tr>
		<td style=\"border:$bgcolor3;cursor:pointer;\" colspan=2 align=center id=mo onclick="muestra_tabla(document.all.tabla_disciplina,5);">
			<img id="imagen_5" src="../../imagenes/drop2.gif" border=0 title="Mostrar columnas" align="left" style="cursor:pointer;">
...
?>
	<tr>
		<td style=\"border:$bgcolor3;cursor:pointer;\" colspan=2 align=center id=mo onclick="muestra_tabla(document.all.tabla_acc_lab,6);">
			<img id="imagen_6" src="../../imagenes/drop2.gif" border=0 title="Mostrar columnas" align="left" style="cursor:pointer;">
...
{?>
<tr>
		<td style=\"border:$bgcolor3;cursor:pointer;\" colspan=2 align=center id=mo onclick="muestra_tabla(document.all.tabla_sumario,7);">
			<img id="imagen_7" src="../../imagenes/drop2.gif" border=0 title="Mostrar columnas" align="left" style="cursor:pointer;">
