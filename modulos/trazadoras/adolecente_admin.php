...
if ($_POST['guardar'] == "Guardar Planilla") {
    ...
    $query = "INSERT INTO trazadoras.adolecentes
             (cuie,clave,clase_doc,tipo_doc,num_doc,apellido,nombre,fecha_nac,fecha_control,peso,talla,
              imc,percen_imc_edad,tamin,tamax,observaciones,fecha_carga,usuario,sexo,codnomenclador)
             VALUES
             ('$cuie','$clave_beneficiario','$clase_doc','$tipo_doc','$num_doc','$apellido','$nombre','$fecha_nac',
             '$fecha_control','$peso','$talla','$imc','$percen_imc_edad',$tamin,$tamax,'$observaciones','$fecha_carga',
             '$usuario','$sexo','$codnomenclador')";
...
<form name='form1' action='adolecente_admin.php' method='POST'>    
    ...
    <table style="margin-top: 10px" width="85%" cellspacing=0 border=1 bordercolor=#E0E0E0 align="center" bgcolor='<?= $bgcolor_out ?>' class="bordes">
        ...
        <tr>
            ...
            <td align="left">
                ...
                <font color="Red">Fecha de Control</font></td>		    
        </tr>
