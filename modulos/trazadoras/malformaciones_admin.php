...
if ($_POST['guardar'] == "Actualizar Planilla") {
    ...
    $query = "UPDATE facturacion.detalles_perinatal
             ...
             WHERE id_comprobante='$id_comprobante' and id_concepto='1'";
    ...
    $query = "UPDATE facturacion.detalles_perinatal
             ...
             WHERE id_comprobante='$id_comprobante' and id_concepto='2'";

    sql($query, "Error al insertar la Planilla") or fin_pagina();

    $query = "UPDATE facturacion.detalles_perinatal
               SET cantidad='$dias_uti',monto='$importe_dias_uti'
             WHERE id_comprobante='$id_comprobante' and id_concepto='3'";

    sql($query, "Error al insertar la Planilla") or fin_pagina();

    $query = "UPDATE facturacion.detalles_perinatal
               SET cantidad='$dias_intermedio',monto='$importe_dias_intermedio'
             WHERE id_comprobante='$id_comprobante' and id_concepto='4'";
...
if ($_POST['guardar'] == "Guardar Planilla") {
    ...
    $query = "INSERT INTO facturacion.detalles_perinatal
             ...
             VALUES
             ($id_nomenclador,'$clave_beneficiario',$importe_dias_pre,$dias_pre,1,$id_comprobante,$id_prestacion)";
    ...
    $query = "INSERT INTO facturacion.detalles_perinatal
             (id_nomenclador,clavebeneficiario,monto,cantidad,id_concepto,id_comprobante,id_prestacion)
             VALUES
             ($id_nomenclador,'$clave_beneficiario',$importe_acto_quiru,$acto_quiru,2,$id_comprobante,$id_prestacion)";
    ...
    $query = "INSERT INTO facturacion.detalles_perinatal
             (id_nomenclador,clavebeneficiario,monto,cantidad,id_concepto,id_comprobante,id_prestacion)
             VALUES
             ($id_nomenclador,'$clave_beneficiario',$importe_dias_uti,$dias_uti,3,$id_comprobante,$id_prestacion)";
    ...
    $query = "INSERT INTO facturacion.detalles_perinatal
             (id_nomenclador,clavebeneficiario,monto,cantidad,id_concepto,id_comprobante,id_prestacion)
             VALUES
             ($id_nomenclador,'$clave_beneficiario',$importe_dias_intermedio,$dias_intermedio,4,$id_comprobante,$id_prestacion)";
...
<form name='form1' action='malformaciones_admin.php' method='POST'>
    ...
    <table style="margin-top: 10px" width="85%" cellspacing=0 border=1 bordercolor=#E0E0E0 align="center" bgcolor='<?= $bgcolor_out ?>' class="bordes">
        <tr id="mo">
            <td>
                ...
                <? } ?>
                Malformaciones Quirurgicas <br> <?php echo "Prestacion: " . $codigo . " " . $diagnostico ?>
            </td>
        </tr>
        <tr><td>
