...
if ($_POST['guardar'] == "Guardar Planilla") {
    ...
    $query = "INSERT INTO trazadoras.adultos
             (cuie,clave,tipo_doc,num_doc,apellido,nombre,fecha_control,
                observaciones,fecha_carga,usuario,tamin,tamax,sexo,peso,talla,codnomenclador)
             VALUES
             ('$cuie','$clave_beneficiario','$tipo_doc','$num_doc','$apellido',
             '$nombre','$fecha_control','$observaciones','$fecha_carga','$usuario','$tamin','$tamax','$sexo','$peso','$talla','$codnomenclador')";
...
<form name='form1' action='adulto_admin.php' method='POST'>
                ...
                <table width=90% align="center" class="bordes">
                    ...
                    <tr>
                        <td align="right">
                            <b>Peso:</b>         	</td>         	
                        <td align='left'>
                            <input onKeyPress="return acceptNum(event)" type="text" size="10" value="<?= $peso ?>" name="peso" <?
                            if ($id_planilla)
                                echo "readonly"
                                ?>>
                    ...
                    <tr>
                        <td align="right">
                            <b>Talla:</b>         	</td>         	
                        <td align='left'>
                            <input onKeyPress="return acceptNum(event)" type="text" size="10" value="<?= $talla ?>" name="talla" <?
                            if ($id_planilla)
                                echo "readonly"
                                ?>>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            Min.<input onKeyPress="return acceptNum(event)" type=text id=tamin name=tamin value='' size=5 <?
                            if ($id_planilla)
                                echo "readonly"
                                ?>>    
                            Max.<input onKeyPress="return acceptNum(event)" type=text id=tamax name=tamax value='' size=5 <?
                            if ($id_planilla)
                                echo "readonly"
                                ?>>  
                        </td>
