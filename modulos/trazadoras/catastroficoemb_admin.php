...
if ($_POST['guardar'] == "Guardar Planilla") {
    ...
    $query = "INSERT INTO facturacion.detalles_perinatal
             ...
             VALUES
             ($id_nomenclador,'$clave_beneficiario',$importe_dias_uti,$dias_uti,6,$id_comprobante,$id_prestacion)";
    ...
    $query = "INSERT INTO facturacion.detalles_perinatal
             (id_nomenclador,clavebeneficiario,monto,cantidad,id_concepto,id_comprobante,id_prestacion)
             VALUES
             ($id_nomenclador,'$clave_beneficiario',$importe_dias_comun,$dias_comun,7,$id_comprobante,$id_prestacion)";
...
?>;
    ...
    function calcularTotal() {
        ...
        var dias_comun = $('#dias_comun').val() * concepto6;
...
<form name='form1' action='catastroficoemb_admin.php' method='POST'>
    ...
    <table style="margin-top: 10px" width="85%" cellspacing=0 border=1 bordercolor=#E0E0E0 align="center" bgcolor='<?= $bgcolor_out ?>' class="bordes">
        <tr id="mo">
            <td>
                ...
                <? } ?>
                Embarazada    <br> <?php echo "Prestacion: ".$codigo . " " . $diagnostico ?>
            </td>
        </tr>
        <tr><td>
