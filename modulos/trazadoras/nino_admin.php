...
if ($_POST['guardar_editar']=="Guardar"){
   ...
   $query="update trazadoras.nino set 
             cuie='$cuie', 
             clave='$clave', 
             clase_doc='$clase_doc', 
             tipo_doc='$tipo_doc', 
...
if ($_POST['guardar']=="Guardar Planilla"){
   ...
   $q="select nextval('trazadoras.nino_id_nino_seq') as id_planilla";
   ...
   if ($triple_viral!="")$triple_viral=Fecha_db($triple_viral);
    ...
    $query="insert into trazadoras.nino
             (id_nino,cuie,clave,clase_doc,tipo_doc,num_doc,apellido,nombre,fecha_nac,
  				fecha_control,peso,talla,perim_cefalico,percen_peso_edad,percen_talla_edad,
  				percen_perim_cefali_edad,percen_peso_talla,triple_viral,nino_edad,
  				observaciones,fecha_carga,usuario)
             values
             ('$id_planilla','$cuie','$clave','$clase_doc','$tipo_doc','$num_doc','$apellido','$nombre',
  				'$fecha_nac','$fecha_control','$peso','$talla','$perim_cefalico','$percen_peso_edad',
  				'$percen_talla_edad','$percen_perim_cefali_edad','$percen_peso_talla','$triple_viral',
...
if ($_POST['borrar']=="Borrar"){
	$query="delete from trazadoras.nino
			where id_nino=$id_planilla";
	sql($query, "Error al insertar la Planilla") or fin_pagina();
...
function control_nuevos()
{
 ...
 if(document.all.percen_peso_talla.value=="-1"){
  alert('Debe Seleccionar un Percentilo Peso Talla');
  return false; 
 }  
 if(document.all.perim_cefalico.value==""){
  alert('Debe Ingresar un Perimetro Cefalico');
  return false;
 } 
 if(document.all.percen_perim_cefali_edad.value=="-1"){
  alert('Debe Seleccionar un Percentilo Perimetro Cefalico/Edad');
  return false; 
 }  
...
<form name='form1' action='nino_admin.php' method='POST'>
  ...
  <table width=90% align="center" class="bordes">
     ...
     <tr>
       <td>
        ...
        <td align="right">
			...
			<td align="left">			 	
			 <select name=percen_peso_edad Style="width=257px" <?if ($id_planilla) echo "disabled"?>>
			  <option value=-1>Seleccione</option>
			  <option value=A <?if ($percen_peso_edad=='A') echo "selected"?>>-10</option>
			  <option value=B <?if ($percen_peso_edad=='B') echo "selected"?>>10-90</option>
			  <option value=C <?if ($percen_peso_edad=='C') echo "selected"?>>+90</option>
        ...
        <tr>
         	<td align="right">
         	  <b>Percentilo Talla/Edad MENORES a 1 año:</b>
         	</td>         	
            <td align="left">			 	
			 <select name=percen_talla_edad Style="width=257px" <?if ($id_planilla) echo "disabled"?>>
			  <option value=-1>Seleccione</option>
			  <option value=A <?if ($percen_talla_edad=='A') echo "selected"?>>-3</option>
			  <option value=B <?if ($percen_talla_edad=='B') echo "selected"?>>3-97</option>
			  <option value=C <?if ($percen_talla_edad=='C') echo "selected"?>>+97</option>
        ...
        <tr>
         	<td align="right">
         	  <b>Percentilo Peso/Talla MAYORES a 1 año:</b>
         	</td>         	
            <td align="left">			 	
			 <select name=percen_peso_talla Style="width=257px" <?if ($id_planilla) echo "disabled"?>>
			  <option value=-1>Seleccione</option>
			  <option value=A <?if ($percen_peso_talla=='A') echo "selected"?>>-(-10)</option>
			  <option value=B <?if ($percen_peso_talla=='B') echo "selected"?>>-10 +10</option>
			  <option value=C <?if ($percen_peso_talla=='C') echo "selected"?>>+(+10)</option>
        ...
        <tr>
         	<td align="right">
         	  <b>Percentilo Perimetro Cefalico/Edad:</b>
         	</td>         	
            <td align="left">			 	
			 <select name=percen_perim_cefali_edad Style="width=257px" <?if ($id_planilla) echo "disabled"?>>
			  <option value=-1>Seleccione</option>
			  <option value=A <?if ($percen_perim_cefali_edad=='A') echo "selected"?>>-(-2DS)</option>
			  <option value=B <?if ($percen_perim_cefali_edad=='B') echo "selected"?>>-2DS +2DS</option>
			  <option value=C <?if ($percen_perim_cefali_edad=='C') echo "selected"?>>+(+2DS)</option>
...
<table class="bordes" align="center" width="100%">
 ...
 <tr><td><table width=100% align="center" class="bordes">
  <tr align="center">
   <td>
     <input type=button name="volver" value="Volver" onclick="document.location='nino_listado.php'"title="Volver al Listado" style="width=150px">     
   </td>
  </tr>
 </table></td></tr>
 ...
 <tr><td><table width=100% align="center" class="bordes">
  ...
  <tr align="left">
   <td>
   	<font size="2">Trazadora VIII (Control niño sano menor 1 año): Campos Hasta Fecha de Nacimiento. Fecha de Control. Peso. Percentilo Peso/Edad. Talla. Percentilo Talla/Edad o Percentilo Peso/Talla. Perimetro Cefalico. Percentilo Perimetro Cefalico/Edad </font>
   </td>
  </tr>
  <tr align="left">
   <td>
   	<font size="2">Trazadora IX (Control niño sano mayor 1 año): Campos Hasta Fecha de Nacimiento. Fecha de Control. Peso. Percentilo Peso/Edad. Talla. Percentilo Talla/Edad o Percentilo Peso/Talla.</font>
   </td>
  </tr>
 </table></td></tr>
