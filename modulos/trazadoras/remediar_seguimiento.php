<?php
    ...
    #   Validaciones para verificar si el beneficiario existe en 
   ...
   if (isNuevo($_POST)){
        ...
        <?php
        ### Finaliza la ejecucion del script, por cuestiones graficas y de ubicacion.
        echo $mensaje;
        exit();
   }
    ...
    #   una sentencia sql, para buscar el riesgo en clasificacion.
        ...
        if ($beneficiario->isRegistroValido($rcvg)) {
            ...
            echo "<div align='center'><H1>BENEFICIARIO INVALIDO PARA SEGUIMIENTO<H1></div>";
            echo "<div align='center'><H1>No tiene clasificacion<H1></div>";
            exit();
        }  
    }
...
<form action="remediar_seguimiento.php" method="post" name="formulario" id="formulario">
    ...
    <fieldset>
        ...
        <table width=100% align="center" class="bordes">
            ...
            <input type="hidden" name="clavebeneficiario" value="<?=$parametros["clave_beneficiario"]?>"/>
