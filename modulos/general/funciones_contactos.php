...
echo "<table >";
 echo "<tr>";
    ...
    echo"<td title='$informacion' onclick=\"window.open('$link','','toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=0,left=25,top=10,width=600,height=300');\" style='cursor:pointer'>";
