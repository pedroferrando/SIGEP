...
echo "<td style='cursor:pointer' onclick=\"document.all.filtro.value='$letra'; document.form1.submit();\">$letra</td>";
      }//del for
   echo "</tr>";
   echo "<tr>";
    echo "<td colspan='9' style='cursor:pointer' onclick=\"document.all.filtro.value='Todas'; document.form1.submit();\"> Todos";
    echo "</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td colspan='9' style='cursor:pointer' onclick=\"document.all.filtro.value=''; document.form1.submit();\"> Los mas Usados";
    echo "</td>";
   echo "</tr>";
   echo "</table>";
}  //de la funcion
