...
if($_POST['buscar']){
	...
	if($_POST['f_desde']!='' && $_POST['f_hasta']!=''){
		$where_tmp.=" and remediar_x_beneficiario.fecha_carga between '".Fecha_db($_POST['f_desde'])."' and '".Fecha_db($_POST['f_hasta'])."' ";
	}
...
$sql="select numero_doc, fecha_nacimiento_benef, (apellido_benef||' '||apellido_benef_otro) as ape,(nombre_benef||' '||nombre_benef_otro) as nom,calle,numero_calle,beneficiarios.localidad,municipio,barrio
		...
		,remediar_x_beneficiario.fechaempadronamiento,score_riesgo
		 ...
		 group by numero_doc, fecha_nacimiento_benef,(apellido_benef||' '||apellido_benef_otro),(nombre_benef||' '||nombre_benef_otro),calle,numero_calle,beneficiarios.localidad,municipio,barrio
...
<table border=0 width=100% cellspacing=2 cellpadding=2 bgcolor='<?=$bgcolor3?>' align=center>
  <tr >
    ...
    <td align=right id=mo>Nro. Documento</td>
    <td align=right id=mo>Fec. Nacimiento</td>
    <td align=right id=mo>Apellido</td>
    <td align=right id=mo>Nombre</td>
    <td align=right id=mo>Calle y N�</td>
