  ...
  <table width=100% align="center" class="bordes">
             <tr id="mo">
                <td align="center" colspan="2" >
                    <b> N&uacute;mero de Formulario Remediar + Redes </b><input type="text" maxlength="10" name="num_form_remediar" value="<?=$num_form_remediar?>" ><input type=submit name="buscar_remediar" value="b" title="b" >
               </td>
             </tr>
             <tr id="ma">
         	<td align="left" >
