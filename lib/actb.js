...
function actb(obj,evt,ca){
	...
	/* --- Styles --- */
	var actb_bgColor = '#B7C7D0';
	var actb_textColor = 'black';//'#FFFFFF';
	var actb_hColor = 'white';//'#000000';
	var actb_fFamily = 'Verdana';
	var actb_fSize = '11px';
	var actb_hStyle = 'font-weight="bold"';'text-decoration:underline;font-weight="bold"';
	/* --- Styles --- */
