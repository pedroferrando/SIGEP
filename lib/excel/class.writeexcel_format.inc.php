...
class writeexcel_format {
 ...
 //cambios exel      
    $this->$_xf_index = $other->$_xf_index;
    ...
    $this->$_font_strikeout=$other->$_font_strikeout;
    $this->$_font_outline=$other->$_font_outline;
    $this->$_font_shadow=$other->$_font_shadow;
    $this->$_font_script=$other->$_font_script;
    $this->$_font_family=$other->$_font_family;
    $this->$_font_charset=$other->$_font_charset;
    $this->$_num_format=$other->$_num_format;
    $this->$_hidden=$other->$_hidden;
    $this->$_locked=$other->$_locked;
    $this->$_text_h_align=$other->$_text_h_align;
    $this->$_text_wrap=$other->$_text_wrap;
    $this->$_text_v_align=$other->$_text_v_align;
    $this->$_text_justlast=$other->$_text_justlast;
    $this->$_rotation=$other->$_rotation;
    $this->$_fg_color=$other->$_fg_color;
    $this->$_bg_color=$other->$_bg_color;
    $this->$_pattern=$other->$_pattern;
    $this->$_bottom=$other->$_bottom;;
    $this->$_top=$other->$_top;
    $this->$_left=$other->$_left;
    $this->$_right=$other->$_right;
    $this->$_bottom_color=$other->$_bottom_color;
    $this->$_top_color=$other->$_top_color;
    $this->$_left_color=$other->$_left_color;
    $this->$_right_color=$other->$_right_color;
