/* Ejemplo
<a href="javascript:pickColor('pick1060872924');" id="pick1060872924"
style="border: 1px solid #000000; font-family:Verdana; font-size:10px;
text-decoration: none;">&nbsp;&nbsp;&nbsp;</a>
<input id="pick1060872924field" size="7"
READONLY name="est_color">
<script language="javascript">relateColor('pick1060872924', getObj('pick1060872924field').value);</script>
...
//		}
	 ...
	 function setDiv() {
		...
		elemDiv.innerHTML = '<span style="font-family:Verdana; font-size:11px;">Seleccione un color:<br>'
			+ getColorTable()
			+ '<center><a href="javascript:setColor(\'\');">Ninguno</a></center>'
			+ '</span>';
