...
function Output($file='',$download=false,$tipo_pdf=false)
{
	...
	else
	{
		if($download)
		{
		  header("Pragma: ");//para que se pueda abrir el archivo sin bajarlo. GACZ
		  header("Cache-Control: ");//para que se pueda abrir el archivo sin bajarlo. GACZ
        header("Expires: Mon, 26 Jul 1997 05:00:00 GMT");
		  header("Last-Modified: " . gmdate("D, d M Y H:i:s") . " GMT");
		  header("Cache-Control: must-revalidate");
		  header("Content-Transfer-Encoding: binary");			
